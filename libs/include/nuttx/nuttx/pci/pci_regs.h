...
#define  PCI_BASE_ADDRESS_IO_MASK         (~0x03ul) /* Bit 1 is reserved if address_space = 1 */
...
#define  PCI_ERR_ROOT_MULTI_COR_RCV       0x00000002  /* Multi ERR_COR Received */
#define  PCI_ERR_ROOT_UNCOR_RCV           0x00000004  /* ERR_FATAL/NONFATAL Received */
#define  PCI_ERR_ROOT_MULTI_UNCOR_RCV     0x00000008  /* Multi ERR_FATAL/NONFATAL Received */

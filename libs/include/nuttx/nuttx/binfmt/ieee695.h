...
/* OMF extensions to the comment class.  This class consists of a set
 * of records, identified by subtype (first byte of commentary string).
 */
...
/* Link pass separator.  This record conveys information to the linker about
 * the organization of the file.  The value of the first byte of the
 * commentary string specifies the comment subtype.
...
/* These macros extract un-aligned, little-endian values

...
struct sigcontext
{
    uint32_t  arm_sp;//             (0)  /* R13 = SP at time of interrupt */
    uint32_t  arm_BASEPRI;//             (1)  /* BASEPRI */
    uint32_t  arm_r4;//                  (2)  /* R4 */
    uint32_t  arm_r5;//                  (3)  /* R5 */
    uint32_t  arm_r6;//                  (4)  /* R6 */
    uint32_t  arm_r7 ;//                 (5)  /* R7 */
    uint32_t  arm_r8;//                  (6)  /* R8 */
    uint32_t  arm_r9;//                  (7)  /* R9 */
    uint32_t  arm_r10;//                 (8)  /* R10 */
    uint32_t  arm_r11;//                (9)  /* R11 */
    uint32_t  arm_CONTROL;//             (10) /* CONTROL */
    uint32_t  arm_EXC_RETURN;//          (11) /* EXC_RETURN */
    #ifdef CONFIG_ARCH_FPU
    uint32_t arm_s16;
    uint32_t arm_s17;
    uint32_t arm_s18;
    ...
    uint32_t  arm_r3;//
    uint32_t  arm_r12;//
    uint32_t  arm_lr;//                  (5)  /* R14 = LR */
    uint32_t  arm_pc;//                  (6)  /* R15 = PC */
    uint32_t  arm_xpsr;//               (7)  /* xPSR */  
    #ifdef CONFIG_ARCH_FPU
    uint32_t arm_s0;
    uint32_t arm_s1;
    uint32_t arm_s2;

# Automatically generated from /home/david/projects/xbb_work/arm-none-eabi-gcc-xpack-13.3.1-1.1/build-assets/build/win32-x64/sources/texinfo-7.0.3/tp/maintain/regenerate_commands_perl_info.pl
...
our %line_commands = (
  ...
  "contents"                => 'skipline',
  "finalout"                => 'skipline',
  "insertcopying"           => 'skipline',
  "lowersections"           => 'skipline',
  "novalidate"              => 'skipline',
  "page"                    => 'skipline',
  "raisesections"           => 'skipline',
  "shortcontents"           => 'skipline',
  "smallbook"               => 'skipline',
  "summarycontents"         => 'skipline',
  "clear"                   => 'special',
  "clickstyle"              => 'special',
  "set"                     => 'special',
  "unmacro"                 => 'special',
...
our %contain_simple_text_commands = (
  "abbr"                    => 1,
  "acronym"                 => 1,
  "anchor"                  => 1,
  "author"                  => 1,

/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/david/projects/xbb_work/arm-none-eabi-gcc-xpack-13.3.1-1.1/build-assets/build/win32-x64/sources/gcc/gcc/config/arm/arm.md'.  */
